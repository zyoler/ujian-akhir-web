const elemenOutput2=document.querySelector('#output2');
const elemenCountry=document.querySelector('#country');

function negara(count){
    elemenOutput2.innerHTML="";
        fetch('https://api-filmapik.herokuapp.com/country?search='+count)
        .then(function(response){
            ...
            for(let i=0;i<json.result.length;i++){
                ...
                elemenOutput2.appendChild(elemendiv);
            }
